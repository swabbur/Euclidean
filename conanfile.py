...
class EuclideanConan(ConanFile):

    # Package info
    name = "euclidean"
    version = "1.0.0"
    license = "MIT"
    url = "https://github.com/swabbur/Euclidean.git"
    description = "A header-only C++ library providing compile-time linear algebra operations"
